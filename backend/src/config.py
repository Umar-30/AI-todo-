...
class Settings:
    ...
    tts_model: str
    tts_voice: str
    # OpenRouter (Optional - legacy, not used)
    ...
    def from_env(cls) -> "Settings":
        ...
        # OpenRouter settings (Optional - legacy)
        openrouter_api_key = os.getenv("OPENROUTE_API_KEY") or os.getenv("OPENROUTER_API_KEY") or ""
